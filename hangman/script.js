...
let options = {
	fruits: ['Apple', 'Blueberry', 'Mandarin', 'Pineapple', 'Pomegranate', 'Watermelon', 'Avocados', 'Blueberry', 'Blackcurrant', 'Ackee', 'Cranberry', 'Cantaloupe', 'Cherry', 'Dates', 'Cherimoya', 'Fig', 'Coconut', 'Grapes', 'Gooseberries', 'Chempedak', 'Hazelnut', 'Honeyberries', 'Dragonfruit', 'Durian', 'Jackfruit', 'Jujube', 'Jenipapo', 'Kiwi', 'Kabosu', 'Kiwano', 'Lime', 'Lychee', 'Longan', 'Langsat', 'Mango', 'Mulberry', 'Pear', 'Lucuma', 'Muskmelon', 'Naranjilla', 'Mangosteen', 'Nectarine', 'Nance', 'Quince', 'Olive', 'Oranges', 'Ramphal', 'Mouse', 'melon', 'Papaya', 'Peach'],
